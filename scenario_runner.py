...
"Wash"]
    ...
    scenario_list = ["hotlist_{}".format(i) for i in range(0,28)]

    driver = webdriver.Chrome("/Users/anabaez/Google Drive/Tullett Prebon/Scenarios/scripts/chromedriver")

    config_dict = {"Driver": "/Users/anabaez/Google Drive/Tullett Prebon/Scenarios/scripts/chromedriver",
                   "Admin": "http://130.211.65.247:18081/dashboard/secure/dashboard#!search"}
