...
if __name__ == '__main__':
    ...
    search_value = "scenario:noise_200"
    buffer_id = ""
    buffer_name = ""
    name = ""
        ...
        #iteration by contents
            ...
            while True:
                try:
                    ...
                    show_more_button.click()  # click on the Show more button
                    time.sleep(1.5)
                    cntr = 0
                    while True:
                        try:
                            id = driver.find_element_by_xpath(
                                "//div[@class='v-verticallayout v-layout v-vertical v-widget v-has-width v-margin-top v-margin-right v-margin-bottom v-margin-left']/div[1]/div[1]/div[2]/div[1]/table/tbody/tr[1]/td[3]/div")
                            tmp_flag = False
                        except selenium.common.exceptions.NoSuchElementException:
                            cntr = cntr + 1
                            if cntr % 10 == 0:
            ...
            print str(id.text)  # print message id
